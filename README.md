...
An interactive static showcase for **TruthLens**, an AI-powered note-taking workspace that
**fact-checks study notes sentence-by-sentence**, returning corrections with reasoning and sources.
...
with a scripted interactive fact-check demo. Built from scratch.
